...
Name:           {{{ git_name name=freecad }}}
Epoch:          1
Version:        0.18_pre
Release:        {{{ git_version lead=1 follow=1 }}}%{dist}
...
%prep
%setup -q -n freecad-{{{ git_version lead=1 follow=1 }}}
...
install -pm 0644 ../package/debian/freecad.sharedmimeinfo %{buildroot}%{_datadir}/mime/packages/%{name}.xml

# Install appdata file
mkdir -p %{buildroot}%{_datadir}/appdata
install -pm 0644 ../package/debian/freecad.appdata.xml %{buildroot}%{_datadir}/appdata/
...
%exclude %{_docdir}/freecad/ThirdPartyLibraries.html
%{_bindir}/*
